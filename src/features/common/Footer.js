...
const disclosureStyle = {
    background: 'linear-gradient(to right,#f8fafc,#ecfeff)', // Replace these colors with your desired gradient
  };



function Footer() {     return (
        <div className="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4"style={disclosureStyle}>
          <div className="2xl:mx-auto 2xl:container flex justify-center items-center   md:py-12 py-9 xl:px-20 sm:px-6 px-4 ">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
                <div className="flex flex-col flex-shrink-0">
                    ...
                    <p className="text-sm leading-none text-gray-800 mt-4">Copyright © 2023 NamasteMart</p>
            ...
            <div className="flex justify-center my-10">
              <div className="flex items-center border w-auto rounded-lg px-4 py-2 w-52 mx-2">
                ...
                <div className="text-left ml-3">
                  <p className="text-xs text-black-200">Download on </p>
